...
namespace HoloCart.Core.Mapping.ShippingAddressMapping
{
    ...
    {
        public void GetAllShippingAddressMapping()
        {
            CreateMap<ShippingAddress, GetAllShippingAddressResponse>().ForMember(dest => dest.UserId, opt => opt.MapFrom(src => src.ApplicationUserId));
