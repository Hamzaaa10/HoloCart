...
{
    public class UpdateProductImageValidation : AbstractValidator<CreateProductImageCommand>
    {
        private readonly IProductColorService _productColorService;

        public UpdateProductImageValidation(IProductColorService productColorService)
        {
