...
{
    public class UpdateProductColorValidations : AbstractValidator<UpdateProductColorCommand>
    {
        private readonly IProductService _productService;

        public UpdateProductColorValidations(IProductService productService)
        {
